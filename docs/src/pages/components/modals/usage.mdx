...
<table style="width: 100%">
  <tbody>
    ...
    <tr style="vertical-align: top">
      <td>Minimum margin<br/><em>(top,bottom)</em></td>
      <td>64px, 64px</td>
      <td>-</td>
    </tr>
    <tr style="vertical-align: top">
...
<Preview name="components-modal-scrolling--scrolling" />
...
<Preview name="components-fullscreenmodal-two-steps--two-steps" />
...
<Preview name="components-fullscreenmodal-scrolling--scrolling" />