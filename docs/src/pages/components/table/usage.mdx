...
<Preview name='components-table-resource-table--resource-table' />
...
<Preview name='components-table-data-table--data-table' />
...
<Preview name='components-table-table-as-option-list--table-as-option-list' />
...
<Preview name='components-table-table-as-description-list--table-as-description-list' />
...
<table style="width: 100%">
  <tbody>
    <tr style="vertical-align: top">
      ...
      <th style="width:25%; text-align: left;">Header row height</th>
      <th style="width:25%; text-align: left;">Body row padding (vertical)</th>
      <th style="width:25%; text-align: left;">Body row padding (horizontal)</th>
    </tr>
    <tr style="vertical-align: top">
      <td>Standard</td>
      <td>40px</td>
...
<Preview name='components-table-standard-table--standard-table' />

#### Compressed table

<br/>

<Preview name='components-table-compressed-table--compressed-table' />

#### Tight table

This size is typically suited for information-dense data tables.

<Preview name='components-table-tight-table--tight-table' />
...
<Preview name='components-table-variants-nested-rows--nested-rows' />

##### With nested card

<Preview name='components-table-nested-table-with-nested-cards--nested-table-with-nested-cards' />
...
Standard table cells cover the most frequent use cases. For the other use cases, a custom cell can be created by using the **Empty Cell component**. Minimum padding of **12px** from either side of the empty cell is maintained.
...
![No items selected](./images/table-14.png)
...
![A few items selected](./images/table-15.png)
...
![All items on the page selected](./images/table-16.png)
...
![All items selected](./images/table-17.png)
...
![All items selected](./images/table-18.png)
...
![Panel can be closed in this case](./images/table-21.png)
