...
<table style="width: 100%">
  <tbody>
    <tr>
      <th style="width:33%; text-align: left;">Size</th>
      <th style="width:33%; text-align: left;">Breakpoint &#60;= Small</th>
      <th style="width:33%; text-align: left;">Breakpoint =&#62; Medium</th>
    </tr>
...
<Preview name='components-sidesheet-regular--regular'/>

#### Large

The large side sheet takes **10 columns** in the grid and starts from left side of the screen.

<Preview name='components-sidesheet-large--large'/>
...
<Preview name='components-sidesheet-two-steps--two-steps'/>
